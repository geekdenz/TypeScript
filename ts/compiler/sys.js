    ...
    ts.sys = (function () {
        function getWScriptSystem() {
            ...
            function readDirectory(path, extension, exclude) {
                var result = [];
                exclude = map(exclude, function (s) { return getCanonicalPath(combinePaths(path, s)); });
                visitDirectory(path);
                return result;
                function visitDirectory(path) {
                    ...
                    for (var _i = 0; _i < files.length; _i++) {
                        ...
                        if ((!extension || fileExtensionIs(name_1, extension)) && !contains(exclude, getCanonicalPath(name_1))) {
                            result.push(name_1);
                        }
                    }
                    ...
                    for (var _a = 0; _a < subfolders.length; _a++) {
                        ...
                        if (!contains(exclude, getCanonicalPath(name_2))) {
        ...
        function getNodeSystem() {
            ...
            function readDirectory(path, extension, exclude) {
                ...
                function visitDirectory(path) {
                    ...
                    for (var _i = 0; _i < files.length; _i++) {
                        var current = files[_i];
                        var name_3 = combinePaths(path, current);
                        if (!contains(exclude, getCanonicalPath(name_3))) {
                            var stat = _fs.statSync(name_3);
                            if (stat.isFile()) {
                                if (!extension || fileExtensionIs(name_3, extension)) {
                                    result.push(name_3);
                                }
                            }
